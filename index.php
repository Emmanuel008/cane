...
<body id="top">
    ...
    <!-- Home Section -->
    <section class="s-home target-section" data-image-src="images/saba.jpg" data-natural-height="2000" data-natural-width="3000" data-parallax="scroll" data-position-y="center" id="home">
    <div class="overlay"></div>
    <div class="shadow-overlay"></div>
    <video autoplay loop muted playsinline>
        <source src="images/saba.jpg" type="video/mp4">
    </video>
    ...
    <div class="row clients-outer item-center justify-content-center" data-aos="">
        <div class="col-full">
            <div class="clients">
                ...
                <a class="clients__slide" href="#0" title=""><img src="images/outbox.jfif" class="object-fit"/></a>
